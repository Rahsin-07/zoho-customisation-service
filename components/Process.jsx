...
// Section 8 — Our proven 6-step Zoho customization process
const steps = [
  { num: '01', icon: 'bi-search',              title: 'Discovery & process mapping',     desc: "We connect with your stakeholders, trace your existing processes, pinpoint the gaps, and record the KPIs that need to be shifted by customization." },
  { num: '02', icon: 'bi-diagram-3-fill',      title: 'Solution architecture',            desc: 'Before a single line of code is written, a senior Zoho architect designs the target state — modules, automation, integrations, security, reporting.' },
  { num: '03', icon: 'bi-sliders',             title: 'Configuration first, code second', desc: 'We use native Zoho configuration wherever possible, reserving custom Deluge for genuinely unique requirements. This keeps your environment upgrade-safe.' },
  { num: '04', icon: 'bi-hammer',              title: 'Iterative build & sandbox testing', desc: 'Build in a sandbox. Demo every two weeks. Adjust based on stakeholder feedback. No big-bang surprises at the end of the project.' },
  { num: '05', icon: 'bi-mortarboard',         title: 'UAT, training & go-live',           desc: "We don't just deploy — we run user training, prepare adoption playbooks, and support your team through go-live week." },
  { num: '06', icon: 'bi-activity',            title: 'Hyper-care & optimization',         desc: 'After go-live, we track usage, optimize automations and suggest the next set of optimizations to maintain a healthy Zoho ecosystem.' },
]
      ...
      <div className="container position-relative">
        <div className="text-center mb-5 fade-up">
          ...
          <p style={{
            ...
            No surprises, no scope creep. Just a transparent path from discovery to a Zoho environment your teams love using.
          </p>
        </div>
